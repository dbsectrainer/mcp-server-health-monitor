...
export declare function getAllServerStatuses(
  db: Database.Database,
  knownServers: string[],
): ServerStatusSummary[];
export declare function getDegradedServers(
  db: Database.Database,
  knownServers: string[],
...
export declare function getLastSchema(
  db: Database.Database,
  serverName: string,
...
export declare function getServerHistory(
  db: Database.Database,
  serverName: string,
  limit: number,
): HealthHistoryRow[];
