 ...
 */
export declare function calculateUptime(db: Database.Database, serverName: string, windowDays: number, slaTarget?: number): UptimeReport;
/**
 ...
 * @param slaTarget   - SLA target percentage (default: 99.9).
 */
export declare function getAllUptimeReports(db: Database.Database, windowDays: number, slaTarget?: number): UptimeReport[];
