 ...
 */
async function sendSlackAlert(webhookUrl, transition) {
 ...
 */
async function sendPagerDutyAlert(routingKey, transition) {
 ...
 */
async function sendGenericWebhookAlert(webhookUrl, transition) {
 ...
 */
export async function sendAlert(channels, transition) {
    const tasks = [];
